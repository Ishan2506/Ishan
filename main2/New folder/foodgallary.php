    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <div class="content">
               ...
               <input type="hidden" name="product_name" value="Did Special Burger">
        ...
        <div class="box">
            ...
            <div class="content">
                ...
                <p>Lorem ipsum  sit, amet consectetur adipisicing elit. Deleniti, ipsum.</p>
                <form method="post" action="">
               <input type="hidden" name="product_name" value="Did Special Cake">
        ...
        <div class="box">
            ...
            <div class="content">
                ...
                <p>Lorem ipsum  sit, amet consectetur adipisicing elit. Deleniti, ipsum.</p>
                <form method="post" action="">
               <input type="hidden" name="product_name" value="Did Special Coffee">
        ...
        <div class="box">
            ...
            <div class="content">
                ...
                <p>Lorem ipsum  sit, amet consectetur adipisicing elit. Deleniti, ipsum.</p>
                <form method="post" action="">
               <input type="hidden" name="product_name" value="Did Special Pizza">
            <input type="hidden" name="product_price" value="360">
