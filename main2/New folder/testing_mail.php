   ...
   if(mysqli_num_rows($result) > 0){
    ...
    echo '<script>alert("Email Alredy Exists");</script>';
      ...
      if($pass != $cpass)
      {
        ...
        We are delighted to welcome you to DID Cafe, where you can discover a cozy and welcoming place to enjoy great coffee, delicious food, and good company. Thank you for joining our community of coffee lovers and food enthusiasts!
        
        If you have any questions or feedback, please do not hesitate to contact us. We are always happy to hear from our customers and strive to make your experience at DID Cafe the best it can be.
        
        Thank you for choosing DID Cafe. We look forward to serving you soon!
        ...
        $mail->isHTML(true);
        $mail->Subject = "Welcome to DID Cafe - Your Go-To Destination for Great Coffee and More!";
        $mail->Body = $body;
